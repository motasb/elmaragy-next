...
import { videosGallery } from "@/lib/data";
  ...
  return (
    <section className="py-12 bg-background" id="OurStudents">
      <div className="container mx-auto px-4">
        <MainTitle badge="Our Students Sessions" title="Live Sessions With Our Students And Teachers"/>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {videosGallery.map((video) => (
            <div key={video.id} className="bg-background-secondary rounded-lg shadow-md overflow-hidden">
              <iframe
